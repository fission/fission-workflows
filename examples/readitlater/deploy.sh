...
fission fn create --env python3 --name redis-get --src redis.zip --entrypoint "redis.get" --buildcmd "./build.sh"
fission fn create --env python3 --name redis-append  --src redis.zip --entrypoint "redis.append" --buildcmd "./build.sh"