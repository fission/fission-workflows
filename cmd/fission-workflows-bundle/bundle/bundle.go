...
func runWorkflowApiServer(s *grpc.Server, es fes.EventStore, resolvers map[string]fnenv.RuntimeResolver,
...
func setupWorkflowController(wfCache fes.CacheReader, es fes.EventStore,
